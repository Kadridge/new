      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="<?php if($this->params['controller'] == 'posts' && $this->params['action'] == 'admin_index'){echo 'active';} ?>"><?php echo $this->Html->link('Edit Post', array('controller' => 'posts', 'action' => 'admin_index')); ?></li>
            <li class="<?php if($this->params['controller'] == 'users' && $this->params['action'] == 'admin_index'){echo 'active';} ?>"><?php echo $this->Html->link('Edit User', array('controller' => 'users', 'action' => 'admin_index')); ?></li>
